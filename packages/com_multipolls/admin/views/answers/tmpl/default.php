...
<form action="<?php echo JRoute::_( 'index.php?option=com_multipolls&view=answers' ); ?>" method="post" name="adminForm" id="adminForm">
    		...
    		<table class="table table-striped" id="answerList">
    			...
    			<tbody>
	    			<?php foreach ( $this->items as $i => $item ) :                		                		              		
	            		$canChange = $this->user->authorise( 'core.edit.state', 'com_multipolls.answers' . $item->id );
	            		$canEdit_answer = $this->user->authorise('core.edit', 'com_multipolls.answer.' . $item->id);
	            	...
	            	<tr class="row<?php echo $i % 2; ?>">	            		           		
	            		...
	            		<td class="center">
	                        <div class="btn-group">
	                            <?php echo JHtml::_('jgrid.published', $item->published, $i, 'answers.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
	                        </div>
	                    </td>	                    	
	            		<td class="has-context">
							<div class="pull-left break-word">
								<?php if ($canEdit_answer) : ?>
									<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_multipolls&task=answer.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
